...
class HtmlBodyTableTrTag: HtmlBodyGroup<HtmlBodyTableThTdTag>, HtmlBodyIdAttribute {
    private val bodyList: MutableList<HtmlBodyTableThTdTag> = ArrayList()
    override var id: String? = null

    override fun getTagString(): String = "tr"
    ...
    override fun getBodyList(): MutableList<HtmlBodyTableThTdTag> = bodyList
}
